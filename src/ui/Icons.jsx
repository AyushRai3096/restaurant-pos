...
/* Recent - Petpooja's recent_icon() */
export const IconRecentTab = (p) => (
  <svg viewBox="0 0 36 36" fill="none" {...p}>
    <path d="M18 3.375C15.5272 3.3776 13.0953 4.00659 10.9313 5.20327C8.76736 6.39995 6.9418 8.12532 5.625 10.2184V7.875C5.625 7.57663 5.50647 7.29048 5.29549 7.07951C5.08452 6.86853 4.79837 6.75 4.5 6.75C4.20163 6.75 3.91548 6.86853 3.7045 7.07951C3.49353 7.29048 3.375 7.57663 3.375 7.875V13.5C3.375 13.7984 3.49353 14.0845 3.7045 14.2955C3.91548 14.5065 4.20163 14.625 4.5 14.625H10.125C10.4234 14.625 10.7095 14.5065 10.9205 14.2955C11.1315 14.0845 11.25 13.7984 11.25 13.5C11.25 13.2016 11.1315 12.9155 10.9205 12.7045C10.7095 12.4935 10.4234 12.375 10.125 12.375H6.9885C7.98845 10.4155 9.49267 8.758 11.3462 7.57317C13.1998 6.38835 15.3357 5.71905 17.5339 5.63421C19.7322 5.54937 21.9133 6.05205 23.8527 7.09049C25.7921 8.12892 27.4196 9.66556 28.5676 11.5422C29.7156 13.4187 30.3426 15.5674 30.384 17.7669C30.4254 19.9664 29.8798 22.1372 28.8033 24.0557C27.7268 25.9742 26.1583 27.571 24.2594 28.6818C22.3605 29.7925 20.1999 30.377 18 30.375C17.6524 30.375 17.3149 30.366 16.9774 30.3345C16.6802 30.3073 16.3844 30.3994 16.1551 30.5903C15.9257 30.7812 15.7817 31.0554 15.7545 31.3526C15.7273 31.6498 15.8194 31.9456 16.0103 32.1749C16.2012 32.4043 16.4755 32.5483 16.7726 32.5755C17.1776 32.6126 17.5826 32.625 18 32.625C21.8788 32.625 25.5987 31.0842 28.3414 28.3414C31.0842 25.5987 32.625 21.8788 32.625 18C32.625 14.1212 31.0842 10.4013 28.3414 7.65856C25.5987 4.91584 21.8788 3.375 18 3.375Z" fill="currentColor" />
    <path d="M18 9C17.7016 9 17.4155 9.11853 17.2045 9.32951C16.9935 9.54048 16.875 9.82663 16.875 10.125V19.125C16.875 19.4234 16.9935 19.7095 17.2045 19.9205C17.4155 20.1315 17.7016 20.25 18 20.25H27C27.2984 20.25 27.5845 20.1315 27.7955 19.9205C28.0065 19.7095 28.125 19.4234 28.125 19.125C28.125 18.8266 28.0065 18.5405 27.7955 18.3295C27.5845 18.1185 27.2984 18 27 18H19.125V10.125C19.125 9.82663 19.0065 9.54048 18.7955 9.32951C18.5845 9.11853 18.2984 9 18 9Z" fill="currentColor" />
    <path d="M13.5 19.125H4.5C4.20163 19.125 3.91548 19.2435 3.7045 19.4545C3.49353 19.6655 3.375 19.9516 3.375 20.25C3.375 20.5484 3.49353 20.8345 3.7045 21.0455C3.91548 21.2565 4.20163 21.375 4.5 21.375H13.5C13.7984 21.375 14.0845 21.2565 14.2955 21.0455C14.5065 20.8345 14.625 20.5484 14.625 20.25C14.625 19.9516 14.5065 19.6655 14.2955 19.4545C14.0845 19.2435 13.7984 19.125 13.5 19.125Z" fill="currentColor" />
    <path d="M13.5 30.375H4.5C4.20163 30.375 3.91548 30.4935 3.7045 30.7045C3.49353 30.9155 3.375 31.2016 3.375 31.5C3.375 31.7984 3.49353 32.0845 3.7045 32.2955C3.91548 32.5065 4.20163 32.625 4.5 32.625H13.5C13.7984 32.625 14.0845 32.5065 14.2955 32.2955C14.5065 32.0845 14.625 31.7984 14.625 31.5C14.625 31.2016 14.5065 30.9155 14.2955 30.7045C14.0845 30.4935 13.7984 30.375 13.5 30.375Z" fill="currentColor" />
    <path d="M13.5 24.75H4.5C4.20163 24.75 3.91548 24.8685 3.7045 25.0795C3.49353 25.2905 3.375 25.5766 3.375 25.875C3.375 26.1734 3.49353 26.4595 3.7045 26.6705C3.91548 26.8815 4.20163 27 4.5 27H13.5C13.7984 27 14.0845 26.8815 14.2955 26.6705C14.5065 26.4595 14.625 26.1734 14.625 25.875C14.625 25.5766 14.5065 25.2905 14.2955 25.0795C14.0845 24.8685 13.7984 24.75 13.5 24.75Z" fill="currentColor" />
  </svg>
);

/* All - Petpooja's liveview_all(): a four-square grid */
export const IconAllTab = (p) => (
...
/* Eye used beside item names in the item list - lighter than the one on the
   table cards, which needs to read at a glance across the floor plan. */
export const IconEyeLight = (p) => (
  <svg {...base} {...p}>
    <path d="M2.06 12.35a1 1 0 0 1 0-.7 10.75 10.75 0 0 1 19.88 0 1 1 0 0 1 0 .7 10.75 10.75 0 0 1-19.88 0" />
    <circle cx="12" cy="12" r="3" />
  </svg>
